...
class Rozmitacka(models.Model):
    ...
    impregnace = models.CharField(max_length=128, choices=[("Ano", "Ano"), ("Ne", "Ne")], default="Ano")
    kapovani = models.CharField("Kapování", max_length=128, choices=[("Ano", "Ano"), ("Ne", "Ne")], default="Ano")
